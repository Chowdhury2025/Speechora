...
class _Presentation3State extends State<Presentation3> with SingleTickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Colors.orangeAccent.withOpacity(0.7) : Colors.white,
          borderRadius: BorderRadius.circular(16),
          boxShadow: [
            BoxShadow(
              color: isSelected ? Colors.orange.withOpacity(0.5) : Colors.black12,
