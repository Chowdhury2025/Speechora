...
class DailyLifeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final routineItems = [
      ...
      'Eat breakfast', 'Take medicine', 'Pack bag', 'Wait for bus', 'Go to school',
      'Come home', 'Take off shoes', 'Do homework', 'Watch TV', 'Eat dinner',
      ...
      children: routineItems.map((item) => 
        SizedBox(
          ...
          child: Card(
            ...
            child: InkWell(
              onTap: () {
                // TODO: Add video or detailed view for each routine item
              },
              child: Column(
