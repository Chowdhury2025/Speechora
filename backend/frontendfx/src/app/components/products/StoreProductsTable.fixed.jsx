      ...
      try {
        ...
        if (selectedStore !== "All") {
          try {
            ...
            const storeResponse = await axios.get(`${API_URL}/api/stores`);
          ...
          {!isLoading && (
            <div className="grid grid-cols-4 gap-4 mb-4 bg-gray-700 p-4 rounded-lg">
              {(() => {
                ...
                const totals = calculateStoreTotals(filteredProducts);
                ...
                // Use API data instead of calculated data for consistency with Calendar
                const displayUnits = monthlyApiData.totalUnitsSold || totals.totalUnitsSold;
                const displayProfit = monthlyApiData.totalProfit || totals.totalProfit;
